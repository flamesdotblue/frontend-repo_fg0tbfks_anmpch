...
export default function App() {
  useEffect(() => {
    const title = 'Maison Vera Parfums — A Quiet, Modern Luxury';
    const desc = 'Minimalist fragrances with an iridescent edge. Explore Édition Noire, Lumière Irisée, and Cuir Serein — crafted for intimacy and presence.';
    ...
    ensure('meta', { name: 'theme-color', content: '#0b0a10' });
      ...
      <header className="sticky top-0 z-40 backdrop-blur supports-[backdrop-filter]:bg-black/40 bg-black/30">
        <div className="mx-auto max-w-6xl px-6 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 text-zinc-300">
            <a href="#models" className="hover:text-white">Collection</a>
            <a href="#shop" className="hover:text-white">Waitlist</a>
            <a href="#about" className="hover:text-white">Story</a>
            <a href="#warranty" className="hover:text-white">Craft</a>
            <a href="#contact" className="hover:text-white">Contact</a>
          </nav>
          <a href="#shop" className="inline-flex rounded-full bg-zinc-100 text-black px-4 py-1.5 text-sm font-medium hover:bg-white">Join Waitlist</a>
        </div>
      </header>
